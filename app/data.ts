...
export const content = [
...

  {
    ...
    subtitle:
      "Liderazgo en el Diseño y Ejecución de Asociaciones Público-Privadas.",
  ...
  },
  {
    id: "4",
    image:
      "https://images.unsplash.com/photo-1479142506502-19b3a3b7ff33?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    title: "Derecho de la Energía y Sustentabilidad",
    subtitle: "Liderando la Estrategia Legal en la Transición Energética.",
    description: `En un mercado energético mexicano en constante evolución, BDP se ha consolidado como un actor clave, ofreciendo servicios de consultoría y litigio que abarcan la totalidad del sector: desde las etapas iniciales de exploración y producción hasta la comercialización y venta de productos energéticos. Nuestra experiencia está diseñada para asegurar la viabilidad jurídica y operativa de sus proyectos más ambiciosos.
  ...
  },
  {
    id: "5",
    image:
      "https://images.unsplash.com/photo-1589391886645-d51941baf7fb?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    title: "Consultoría en Política Pública",
    subtitle:
      "Del Litigio a la Ley: Transformamos Ideas en Soluciones de Alto Impacto.",
    description: `BDP se distingue por ser la primera firma en México que logra integrar de forma sinérgica tres pilares esenciales: Litigio, Derecho Regulatorio y Consultoría en Política Pública. Esta combinación nos permite ofrecer una solución completa que va más allá de la defensa legal, actuando directamente en la fuente de la norma para generar un cambio positivo y estratégico.
  ...
  },
  {
    id: "6",
    image:
      "https://images.unsplash.com/photo-1447023029226-ef8f6b52e3ea?q=80&w=1171&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    title: "Derecho Inmobiliario",
    subtitle:
      "Protección de la Propiedad Privada y Asesoría Estratégica Inmobiliaria.",
    description: `En BDP, entendemos que la propiedad inmobiliaria es un pilar fundamental del patrimonio de nuestros clientes y un motor clave para la inversión. Nuestra práctica inmobiliaria se especializa en ofrecer soluciones legales para el sector, combinando la experiencia en litigio con la consultoría regulatoria para proteger sus activos y asegurar el cumplimiento normativo.
  
  Nuestro enfoque se centra en dos áreas críticas para cualquier inversionista o propietario:
  
      Regularización de Inmuebles: Brindamos asesoría experta para resolver las complejidades jurídicas que rodean a la propiedad, garantizando que su inmueble cumpla con todas las normativas de uso de suelo, ambientales y administrativas necesarias para su operación y desarrollo.
  
      Defensa de la Propiedad Privada: Nos especializamos en la defensa activa contra las acciones del Estado o de terceros que puedan menoscabar su derecho de propiedad. Esto incluye la impugnación de leyes, regulaciones, o actos administrativos que resulten perjudiciales o regresivos para sus intereses.
  
  Nuestra estrategia para la defensa de la propiedad es multicanal. No nos limitamos a un solo recurso, sino que diseñamos un plan integral que incluye la impugnación de regulaciones mediante vías judiciales (amparo), administrativas y, cuando es necesario, a través de la promoción de cambios en el ámbito legislativo. Con BDP, usted asegura que su inversión inmobiliaria está respaldada por una defensa legal que es tan sólida como el activo que protege.
